...
(function($) {
    ...
    $.fn.rProgressbar = function(options) {
        options = $.extend({ percentage: null, ShowProgressCount: true, duration: 1000, fillBackgroundColor: '#201f24', backgroundColor: '#b4aeae', borderRadius: '0px', height: '5px', width: '100%' }, options);
        $.options = options;
